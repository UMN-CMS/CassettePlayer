...
const PointVec hdengine_w = {{52.22, -19.164}, {83.22, -19.164}, {93.22, -29.164}, {103.72, -29.164}, {113.72, -19.164}, {115.72, -19.164}, {127.72, -7.164}, {127.72, 32.836}, {115.72, 44.836}, {91.72, 44.836}, {87.22, 40.336}, {81.22, 40.336}, {76.72, 44.836}, {62.72, 44.836}, {50.72, 51.836}, {55.72, 60.836}, {41.72, 68.836}, {29.72, 56.836}, {29.72, 51.836}, {20.72, 42.836}, {34.22, 29.336}, {41.72, 36.836}, {46.72, 36.836}, {52.22, 31.336}};
...
std::unordered_map<CasSlot, Drawable> parseShapes(
    ...
    ret.insert({SlotEngine(),
                Drawable({StyledPolygon{applyTo(
                                            ...
                                            ldengine_w),
                                        COLOR["ENGINE"]}})});
    ret.insert({SlotEngine(SlotModule(),SlotModule(), "HD"),
                Drawable({StyledPolygon{applyTo(
                                            [](const auto& x) {
                                              return Point(x.first * 1,
                                                           x.second * -1);
